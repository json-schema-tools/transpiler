...
type Openrpc string
const (
	OpenrpcEnum0 Openrpc = "1.3.0"
	OpenrpcEnum1 Openrpc = "1.2.6"
	OpenrpcEnum2 Openrpc = "1.2.5"
	OpenrpcEnum3 Openrpc = "1.2.4"
	OpenrpcEnum4 Openrpc = "1.2.3"
	OpenrpcEnum5 Openrpc = "1.2.2"
	OpenrpcEnum6 Openrpc = "1.2.1"
	OpenrpcEnum7 Openrpc = "1.2.0"
	OpenrpcEnum8 Openrpc = "1.1.12"
	OpenrpcEnum9 Openrpc = "1.1.11"
	OpenrpcEnum10 Openrpc = "1.1.10"
	OpenrpcEnum11 Openrpc = "1.1.9"
	OpenrpcEnum12 Openrpc = "1.1.8"
	OpenrpcEnum13 Openrpc = "1.1.7"
	OpenrpcEnum14 Openrpc = "1.1.6"
	OpenrpcEnum15 Openrpc = "1.1.5"
	OpenrpcEnum16 Openrpc = "1.1.4"
	OpenrpcEnum17 Openrpc = "1.1.3"
	OpenrpcEnum18 Openrpc = "1.1.2"
	OpenrpcEnum19 Openrpc = "1.1.1"
	OpenrpcEnum20 Openrpc = "1.1.0"
	OpenrpcEnum21 Openrpc = "1.0.0"
	OpenrpcEnum22 Openrpc = "1.0.0-rc1"
	OpenrpcEnum23 Openrpc = "1.0.0-rc0"
)
...
type OpenrpcDocument struct {
	...
	Schema       *StringPBC4JHUy              `json:"$schema,omitempty"`
}
