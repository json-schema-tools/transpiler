...
pub type SchemaArray = Vec<Undefined>;
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
#[serde(untagged)]
pub enum Items {
    Undefined(Undefined),
...
/// {}
///
pub type Definitions = HashMap<String, Undefined>;
/// Properties
///
/// # Default
///
/// {}
///
pub type Properties = HashMap<String, Undefined>;
/// PatternProperties
///
/// # Default
///
/// {}
///
pub type PatternProperties = HashMap<String, Undefined>;
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
#[serde(untagged)]
...
pub struct JSONSchemaObject {
    ...
    pub additional_items: Option<Undefined>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub additional_properties: Option<Undefined>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub property_names: Option<Undefined>,
    ...
    pub _if: Option<Undefined>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub then: Option<Undefined>,
    #[serde(rename = "else", skip_serializing_if = "Option::is_none")]
    pub _else: Option<Undefined>,
...
///
pub type StringPBC4JHUy = String;
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Builder, Default)]
#[builder(setter(strip_option), default)]
#[serde(default)]
pub struct OpenrpcDocument {
    ...
    #[serde(rename = "$schema", skip_serializing_if = "Option::is_none")]
    pub schema: Option<StringPBC4JHUy>,
}
